...
import { allCatsTemplate } from "./templates/catsTemplate.js";



function toggleButtonsOfStatusCode(e){
let button = e.target;
...
render(allCatsTemplate(cats, toggleButtonsOfStatusCode), allCatsSection);